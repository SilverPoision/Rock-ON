...
function asn_enum {
    ...
    curl -X POST -H 'Content-type: applicion/json' --data '{"text":"Your ASN Enumeration process for '$asn' has been completed"}' https://hooks.slack.com/services/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
